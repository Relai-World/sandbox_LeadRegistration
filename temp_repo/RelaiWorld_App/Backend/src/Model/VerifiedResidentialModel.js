...
const VerifiedResidentailschema = new mongoose.Schema({
  RERA_Number:{
    type: String,
    required:true,
    unique: true 
...
}, { collection: 'VerifiedResidentialData', timestamps: true });

// Pre-save middleware to update the updatedAt field
VerifiedResidentailschema.pre('save', function(next) {
  this.updatedAt = new Date();
  next();
});

const VerifiedResidentail = mongoose.model('VerifiedResidentialData', VerifiedResidentailschema);

module.exports = VerifiedResidentail;
